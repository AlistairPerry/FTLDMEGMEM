...
datfname <- paste("commconpatplac_remo_wbothsess_noc22_LFP_", ROInames[i], "_MMNmean_rep3_ConsandPats_DrugInt_fullsample_forJASP.txt", sep="")
...
# 3 Groups: Drug Pat Subgroup Interaction ---------------------------------
